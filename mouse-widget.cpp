...
QPoint MouseWidget::mirrorCoords(const QPoint & p) {
   return QPoint(DesignedSize.width() - p.x(), p.y());
}

QPoint MouseWidget::adjustMirroredCoords(const QPoint & p) {
   return adjustCoords(mirrorCoords(p));
}

QPoint MouseWidget::adjustCoords(const QPoint & p) {
   return QPoint(
...
void MouseWidget::drawMouseBody() {
...
void MouseWidget::drawLeftButton(bool down) {
...
void MouseWidget::drawRightButton(bool down) {
   const QPoint &lb_1 = MouseBodyBasePts[5], lb_2(MouseBodyBasePts[5].x(), MouseBodyBasePts[1].y()),
          &lb_3 = MouseBodyBasePts[1],
          &lb_4 = MouseBodyBasePts[3], &lb_5 = MouseBodyBasePts[5],
...
void MouseWidget::drawWheel(int dir) {
   QPainter painter(this);
   painter.setRenderHint(QPainter::Antialiasing, true);
...
void MouseWidget::drawMidButton(bool down) {
